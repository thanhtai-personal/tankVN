    ...
    class GameOver : Microsoft.Xna.Framework.DrawableGameComponent
    {
        ...
        protected override void LoadContent()
        {
            ...
            _btnExit = new GameButton(GLOBAL.Exittexture, GLOBAL.Exittexture2,
                GamePlay.gameZone.Width / 2, GamePlay.gameZone.Height / 2+100);
            _btnReplay = new GameButton(GLOBAL.Playtexture, GLOBAL.Playtexture2,
               GamePlay.gameZone.Width / 2, GamePlay.gameZone.Height / 2);
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            spritebatch.Begin();
            //background
            spritebatch.Draw(GLOBAL.GameOverBG, new Rectangle(0, 0, 700, 600), Color.White);
            //menutable
