...
namespace TankVN
{
    class enermy : tank
    {
        ...
        public void Fire()
        {
            ...
            {
                if ((DanhGia2(Position, GLOBAL.xe.Position) < 26 * 9) || (DanhGia2(Position, GLOBAL.PosObjectProtect) < 26 * 9))
...
#region Normal
                ...
                if (GLOBAL.vachampixel(this.bound, this.Model.MultiFramelist.datacolor, GLOBAL.Bullet[i].Position, GLOBAL.Bullet[i].Model.MultiFramelist.datacolor))
                {
                    if (GLOBAL.Bullet[i].Type == bullet.loaidan.player)
                    {
                        ...
                        if (this.livepoint == 0)
                        {
                            ...
                            {
                                case 1:
                                    GLOBAL.xe.NumEnermyDestroy[1] += 1;
                                    break;
                                case 2:
                                    GLOBAL.xe.NumEnermyDestroy[3] += 1;
                                    break;
                                case 3:
                                    GLOBAL.xe.NumEnermyDestroy[4] += 1;
                                    break;
                                case 0:
                                    GLOBAL.xe.NumEnermyDestroy[2] += 1;
                                    break;
            ...
            if (livepoint <= 0)
            {
                ...
                if (this.HasItem == true)
                {
                    ...
                    GLOBAL.ItemAppearSound.Play(1f,1f,0f);
                ...
                GLOBAL.ExplosionTanksound.Play(0.15f,1f,0f);
